...
const DashboardLayout = ({ children }: { children: React.ReactNode }) => {
  return (
    <main className="grid grid-cols-2 overflow-hidden">
      <nav className="bg-neutral-50 grid-col-[minmax(300px,_1fr)] col-start-3 col-span-10 py-4 px-6">
        nav
      </nav>
      <aside className="w-full border-r flex flex-col col-span-2 row-span-3   col-start-1 row-start-1 bg-green-300">
